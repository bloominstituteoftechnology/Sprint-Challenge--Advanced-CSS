1.) adaptive just means it has @media breaks at certain widths, while fully responsive has that AND all its width settings set as percentages to allow for scalability between the @media breaks.
