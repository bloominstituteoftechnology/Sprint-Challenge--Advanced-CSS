...
1. What is the difference between an adaptive website and a fully responsive website?
   ...
   Responsive website adapts to any size brower, whereas the adaptive website adapts only when the browser reaches a specific point. With responsive design, the browser autofits contents to the page in a smooth seamless manner when the page is being resized, whereas with adaptive design, the browser doesn't autofit anything but snaps into place once it reaches a specific point.

2. Describe what it means to be mobile first vs desktop first.

   It means you start out with building your website for mobile view first. Your base html and CSS are all set to responsive to mobile media query. From that base mobile view, you then add changes to get to the larger tablet or desktop view.

3. What does `font-size: 62.5%` in the `html` tag do for us when using `rem` units?

   62.5% of 16px = 10px, it makes the font size into 10px.
