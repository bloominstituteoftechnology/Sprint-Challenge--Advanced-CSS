...
ANSWER: Responsive design uses responsive units (%'s, rem, etc.) for smooth transtions between breakpoints, adaptive uses fixed units for a more abrupt transition between breakpoints.
