...
In responsive design, the site will adjust to the size of the browser at any given point, while adaptive design looks for more specific break points and screen sizes. Responsive also has one template for all devices, while adaptive design is optimized for each chosen device. Responsive design also uses more responsive units (like %) to set the experience within media queries, while adaptive design uses more specific, hard coded widths in media queries.
